...
namespace Calmfox\SyliusAdminTwoFactorPlugin\DependencyInjection\Compiler;
 ...
 * `two_factor_condition` option, so other packages (e.g. 2FA for shop customers) can add theirs.
 */
final class RegisterTwoFactorConditionPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        $values[] = new Reference('calmfox_admin_two_factor.condition');
