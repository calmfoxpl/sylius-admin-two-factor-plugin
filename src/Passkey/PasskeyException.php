...
final class PasskeyException extends \RuntimeException
{
    ...
    {
        return new self('calmfox_admin_two_factor.passkey.challenge_gone');
    }

    public static function rejected(?\Throwable $previous = null): self
    {
        return new self('calmfox_admin_two_factor.passkey.rejected', 0, $previous);
    }

    public static function alreadyPaired(): self
    {
        return new self('calmfox_admin_two_factor.passkey.already_paired');
    }
}
