...
namespace Tests\Calmfox\SyliusAdminTwoFactorPlugin\Unit\DependencyInjection\Compiler;
...
final class RegisterTwoFactorConditionPassTest extends TestCase
{
    public function testItAddsThePolicyConditionNextToTheExistingOnes(): void
    {
        ...
        self::assertSame(['scheb.existing', 'calmfox_admin_two_factor.condition'], array_map(static fn (mixed $reference): string => $reference instanceof Reference ? (string) $reference : '', $argument->getValues()));
    }
